...
const getLeftKneeAngle = () => {
    let temp = (Math.atan2(leftAnkleY - leftKneeY, leftAnkleX - leftKneeX) - Math.atan2(leftHipY - leftKneeY, leftHipX - leftKneeX)) * (180 / Math.PI)
...
const getRightKneeAngle = () => {
    let temp = (Math.atan2(rightAnkleY - rightKneeY, rightAnkleX - rightKneeX) - Math.atan2(rightHipY - rightKneeY, rightHipX - rightKneeX)) * (180 / Math.PI)

    if (temp >= 0) return (temp - 180)
    else return (temp + 180)
    //return (Math.atan2(rightAnkleY - rightKneeY, rightAnkleX - rightKneeX) - Math.atan2(rightHipY - rightKneeY, rightHipX - rightKneeX)) * (180 / Math.PI)
}

const getLeftHipAngle = () => {
    let temp = ((Math.atan2(leftKneeY - leftHipY, leftKneeX - leftHipX) - Math.atan2(leftShoulderY - leftKneeY, leftShoulderX - leftKneeX)) * (180 / Math.PI))
...
const getRightHipAngle = () => {
    let temp = ((Math.atan2(rightKneeY - rightHipY, rightKneeX - rightHipX) - Math.atan2(rightShoulderY - rightKneeY, rightShoulderX - rightKneeX)) * (180 / Math.PI))

    if (temp >= 0) return (temp - 180)
    else return (temp + 180)
    //return ((Math.atan2(rightKneeY - rightHipY, rightKneeX - rightHipX) - Math.atan2(rightShoulderY - rightKneeY, rightShoulderX - rightKneeX)) * (180 / Math.PI))
}

const getLeftAnkleAngle = () => {
    let temp = (Math.atan2(leftFootIndexY - leftHeelY, leftFootIndexX - leftHeelX) - Math.atan2(leftKneeY - leftAnkleY, leftKneeX - leftAnkleX)) * (180 / Math.PI)
...
const getRightAnkleAngle = () => {
    let temp = (Math.atan2(rightFootIndexY - rightHeelY, rightFootIndexX - rightHeelX) - Math.atan2(rightKneeY - rightAnkleY, rightKneeX - rightAnkleX)) * (180 / Math.PI)

    if (temp >= 0) return (temp - 90)
    else return (temp + 90)
    //return (Math.atan2(rightFootIndexY - rightHeelY, rightFootIndexX - rightHeelX) - Math.atan2(rightKneeY - rightAnkleY, rightKneeX - rightAnkleX)) * (180 / Math.PI)
}

export { updateAngleHelper, getLeftKneeAngle, getRightKneeAngle, getLeftHipAngle, getRightHipAngle, getLeftAnkleAngle, getRightAnkleAngle }