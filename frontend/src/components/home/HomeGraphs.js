    ...
    <>
      <div className="homeGraph">
        ...
        >
          ...
          >
            <Label value="L Hip" position="left"></Label>
          </YAxis>
        ...
        >
          ...
          >
            <Label value="L Knee" position="left"></Label>
          </YAxis>
          <CartesianGrid strokeDasharray="3 3" />
        ...
        >
          ...
          >
            <Label value="L Ankle" position="left"></Label>
          </YAxis>
          <CartesianGrid strokeDasharray="3 3" />
        ...
        >
          ...
          <YAxis
            ...
            ticks={[-30, -25, -20, -15, -10, -5, 0, 5, 10, 15, 20]}
          >
            <Label value="R Hip" position="left"></Label>
          </YAxis>
          <CartesianGrid strokeDasharray="3 3" />
        ...
        >
          ...
          >
            <Label value="R Knee" position="left"></Label>
          </YAxis>
          <CartesianGrid strokeDasharray="3 3" />
        ...
        >
          ...
          >
            <Label value="R Ankle" position="left"></Label>
          </YAxis>
          <CartesianGrid strokeDasharray="3 3" />
